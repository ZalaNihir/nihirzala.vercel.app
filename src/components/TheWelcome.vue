    ...
    <article class="flex-1 flex items-center justify-center">
      <div class="w-full max-w-3xl px-4 py-12">
        <div class="mt-8 prose prose-zinc sm:prose-lg max-w-none">
          <h1>Laravel Developer and part-time Cyber Security Engineer.</h1>
          <p>
            Hi there! I'm Nihir Zala from Rajkot, India, and I like to make
            things. I'm currently building
            <a
              href="https://github.com/ZalaNihir/adminlte-laravel10"
              target="_blank"
              >Admin LTE</a
            >
            and
            <a href="https://github.com/Nihirz/contact-package" target="_blank"
              >Contact Package</a
            >, and I working as a Laravel Developer.
          </p>
        </div>
      </div>
    </article>
